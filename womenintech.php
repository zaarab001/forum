...
<body>
    ...
    <section class="blog_all">
                 <?php
						...
						{
							$wid = $_GET['wid'];
                        $sql = 'SELECT * FROM post_article WHERE categories = "Women_in_tech" && post_id = '.$wid.' ';
        ...
        <div class="container">
            <div class="row m0 blog_row">
                ...
                <div class="col-sm-8 main_blog">
                    ...
                    <a href="womenintech.php?women=34intech498ht62top1bui7lder=<?php echo $token.'&wid='.$post_id.'&token=26hytech6h50kay'; ?>"><?php echo $post_pic;?></a>
                     ...
                     <div class="panel panel-default">
                                 <div class="panel-heading"><a href="" class="pull-right"><h2><i class="fa fa-yelp"></i></h2></a> <h2>Article View</h2></div>
                                  ...
                                  <hr><h4>Manzuma Memunat</h4>
                                    ...
                                    <button name="clap" class="btn btn-md btn-light" type="button"><i class="fa fa-signing"></i> 765</button>
                                    <button name="clap" class="btn btn-md btn-light" type="button"><i class="fa fa-frown-o"></i> 08</button>
                                   ...
                                   <hr><div style="margin-left:45px">
                                    ...
                                    <div class="input-group">
                                      ...
                                      <span class="input-group-btn"><button name="add" class="btn btn-md btn-primary" type="submit"><i class="fa fa-commenting"></i></button></span>
                                    </div>
                                    </form>
                ...
                <div class="resent">
                    ...
                    <div class="resent">
                        ...
                        $sql = "SELECT * FROM post_article WHERE categories = 'Women_in_tech' ORDER BY post_id DESC LIMIT 5 ";
						$query = mysqli_query($connect, $sql);
				...
				?>
                        ...
                        <div class="media">
                            ...
                            <div class="media-body">
                                <a href="womenintech.php?women=34intech498ht62top1bui7lder=<?php echo $token.'&wid='.$post_id.'&token=26hytech6h50kay'; ?>">  <?php echo $title;?></a>
